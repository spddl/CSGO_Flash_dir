...
function executeFilter()
{
   ...
   {
      var _loc2_ = StripSpaces(filterString);
      PreviousFilterString = filterString;
      trace("----------------------->FilterTextToSend" + _loc2_);
      _global.SinglePlayerMovie.Panel.Panel.SendWorkshopFilterData(_global.SinglePlayerMovie.Panel.Panel.strFilterGameMode,_loc2_);
...
function Init()
{
   ...
   PromptPanel.Text.htmlText = "#SFUI_Workshop_Filter_Prompt";
   ...
   {
      _global.SinglePlayerMovie.Panel.Panel.ModeChooser.TabWorkshop.FilterPanel.onProxyPressed();
   };
   filterObject.onRelease = function()
   {
      _global.SinglePlayerMovie.Panel.Panel.ModeChooser.TabWorkshop.FilterPanel.onProxyReleased();
   };
   ...
   {
      _global.SinglePlayerMovie.Panel.Panel.ModeChooser.TabWorkshop.FilterPanel.onProxyMouseMoved();
   };
   selectingFilterWithMouse = false;
}
function Release()
