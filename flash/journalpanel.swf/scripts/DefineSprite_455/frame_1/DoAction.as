function SetUpMissionLeaderboard(objMission)
{
   SetUpMissionLeaderboardsButtons(objMission._ItemID,objMission._PlayerXuid);
   SetUpLister(objMission._LeaderboardType);
}
function SetUpMissionLeaderboardsButtons(strId, PlayerXuid)
{
   BtnPrev.dialog = this;
   ...
   var _loc3_ = _global.GameInterface.Translate("#CSGO_Journal_Leaderboard_Title");
   var _loc4_ = _global.CScaleformComponent_Inventory.GetItemName(PlayerXuid,strId);
   _loc3_ = _global.ConstructString(_loc3_,_loc4_);
   Title.htmlText = _loc3_;
   _global.AutosizeTextDown(Title,8);
}
