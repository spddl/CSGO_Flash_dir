...
function onMarketPress()
{
   ...
   _global.CScaleformComponent_SteamOverlay.OpenURL(_loc3_ + "/market/search?q=&appid=" + _loc2_ + "&lock_appid=" + _loc2_);
}
function ClosePanel()
{
...
function DetectMouseSpeed(obj)
{
   ...
   obj.onEnterFrame = function()
   {
      ...
      m_MouseSpeed = Math.sqrt(x * x + y * y);
      prevX = _root._xmouse;
      prevY = _root._ymouse;
   };
}
function EndMouseSpeedLoop(obj)
{
