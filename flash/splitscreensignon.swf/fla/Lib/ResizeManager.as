class Lib.ResizeManager
{
   ...
   {
      var _loc2_ = this.getSafezone("safezonex");
      var _loc3_ = this.getSafezone("safezoney");
      Lib.ResizeManager.POSITION_SAFE_LEFT = (1 - _loc2_) / 2;
      Lib.ResizeManager.POSITION_SAFE_RIGHT = Lib.ResizeManager.POSITION_SAFE_LEFT + _loc2_;
      Lib.ResizeManager.POSITION_SAFE_TOP = (1 - _loc3_) / 2;
      Lib.ResizeManager.POSITION_SAFE_BOTTOM = Lib.ResizeManager.POSITION_SAFE_TOP + _loc3_;
