class Lib.Tween
{
   static var __initBeacon = Lib.OnEnterFrameBeacon.init();
   static var __initBroadcaster = Lib.BroadcasterMX.initialize(Lib.Tween.prototype,true);
   function Tween(obj, prop, func, begin, finish, duration, useSeconds)
   {
      Lib.OnEnterFrameBeacon.init();
      if(!arguments.length)
      {
         return undefined;
      }
