...
resizeManager.ApplyAdditionalScaling = true;
_global.ElementLoaders = {Reticle:function(gameAPI)
{
   LoadExternalElement("HudReticle.swf","Reticle",2,gameAPI);
},Spectator:function(gameAPI)
{
   LoadExternalElement("Spectator.swf","Spectator",3,gameAPI);
},WeaponSelected:function(gameAPI)
{
   LoadExternalElement("HudWeaponSelected.swf","WeaponSelected",4,gameAPI);
},WeaponModule:function(gameAPI)
{
   LoadExternalElement("HudWeaponModule.swf","WeaponModule",5,gameAPI);
},HealthArmorModule:function(gameAPI)
{
   LoadExternalElement("HudHealthArmorModule.swf","HealthArmorModule",6,gameAPI);
},TeamCount:function(gameAPI)
{
   LoadExternalElement("HudPlayerCountTime.swf","TeamCount",7,gameAPI);
},HelpAchievementModule:function(gameAPI)
{
   LoadExternalElement("HudHelpAchievementModule.swf","HelpAchievementModule",8,gameAPI);
},Radar:function(gameAPI)
{
   LoadExternalElement("HudRadarModule.swf","Radar",9,gameAPI);
},DamageIndicatorModule:function(gameAPI)
{
   LoadExternalElement("HudDamageIndicator.swf","DamageIndicatorModule",10,gameAPI);
},DeathNotice:function(gameAPI)
{
   LoadExternalElement("HudDeathNotification.swf","DeathNotice",11,gameAPI);
},VoiceStatus:function(gameAPI)
{
   LoadExternalElement("HudVoiceStatus.swf","VoiceStatus",12,gameAPI);
},ChooseClass:function(gameAPI)
{
   LoadExternalElement("ChooseClass.swf","ChooseClass",13,gameAPI);
},UniqueAlerts:function(gameAPI)
{
   LoadExternalElement("HudAlertsPanel.swf","UniqueAlerts",40,gameAPI);
},FreezePanel:function(gameAPI)
{
   LoadExternalElement("HudFreezePanel.swf","FreezePanel",44,gameAPI);
},VotePanel:function(gameAPI)
{
   LoadExternalElement("HudVotePanel.swf","VotePanel",295,gameAPI);
},WinPanel:function(gameAPI)
{
   LoadExternalElement("HudWinPanel.swf","WinPanel",99,gameAPI);
},RadioPanel:function(gameAPI)
{
   LoadExternalElement("RadioPanel.swf","RadioPanel",100,gameAPI);
},RosettaSelector:function(gameAPI)
{
   LoadExternalElement("rosettaselector.swf","rosettaselector",101,gameAPI);
},Scoreboard:function(gameAPI)
{
   LoadExternalElement("scoreboard.swf","Scoreboard",102,gameAPI);
},Money:function(gameAPI)
{
   LoadExternalElement("Money.swf","Money",104,gameAPI);
},BuyMenu:function(gameAPI)
{
   LoadExternalElement("buy-menu.swf","BuyMenu",105,gameAPI);
},TeamMenu:function(gameAPI)
{
   LoadExternalElement("ChooseTeam.swf","TeamMenu",106,gameAPI);
},TrialTimer:function(gameAPI)
{
   LoadExternalElement("HudTrialTimer.swf","TrialTimer",200,gameAPI);
},Chat:function(gameAPI)
{
   LoadExternalElement("Chat.swf","Chat",250,gameAPI);
},MapOverview:function(gameAPI)
{
   LoadExternalElement("MapOverview.swf","MapOverview",251,gameAPI);
},Autodisconnect:function(gameAPI)
{
   LoadExternalElement("Autodisconnect.swf","Autodisconnect",300,gameAPI);
